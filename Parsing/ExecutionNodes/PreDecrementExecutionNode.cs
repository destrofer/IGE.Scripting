...
namespace IGE.Scripting.ExecutionNodes {
	/// <summary>
	/// </summary>
	public class PreDecrementExecutionNode : Math1ExecutionNode {
		public override bool AffectsVariable { get { return true; } }
		
		public PreDecrementExecutionNode(IExecutionTreeNode parent, int line, int character) : base(parent, line, character) {
		}
