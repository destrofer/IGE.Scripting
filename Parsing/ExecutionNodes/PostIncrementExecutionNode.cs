...
namespace IGE.Scripting.ExecutionNodes {
	/// <summary>
	/// </summary>
	public class PostIncrementExecutionNode : Math1ExecutionNode {
		public override bool AffectsVariable { get { return true; } }
		
		public PostIncrementExecutionNode(IExecutionTreeNode parent, int line, int character) : base(parent, line, character) {
		}
