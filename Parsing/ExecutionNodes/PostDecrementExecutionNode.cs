...
namespace IGE.Scripting.ExecutionNodes {
	/// <summary>
	/// </summary>
	public class PostDecrementExecutionNode : Math1ExecutionNode {
		public override bool AffectsVariable { get { return true; } }
		
		public PostDecrementExecutionNode(IExecutionTreeNode parent, int line, int character) : base(parent, line, character) {
		}
